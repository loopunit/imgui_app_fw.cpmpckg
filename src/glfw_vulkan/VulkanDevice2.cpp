...
namespace FGC
{
	...
	*/
	...
	bool VulkanDevice2Initializer::ChooseDevice(StringView deviceName)
	{
		...
		WithPhysicalDevices(*this, [deviceName, &pdev](VkPhysicalDevice dev, auto& prop, auto&...) {
	...
	*/
	bool VulkanDevice2Initializer::ChooseHighPerformanceDevice()
	{
		...
		WithPhysicalDevices(*this, [&any_device, &high_perf_device, &max_performance](VkPhysicalDevice dev, auto& prop, auto& feat, auto&) {
